    ...
    <div className="contenedor-padre">
        ...
        <div className="nav2">
          <li className="dropdown">
            ...
            <ul className="submenu">
              ...
              <li><a href="#dogs">Beds</a></li>
              <li><a href="#dogs">Accessories</a></li>
            </ul>
          </li>
      ...
      <section>
        <div className="section2">
          ...
          <button type="button" className="boton-registro" onClick={scrollToFormReg}>
            ¡Register here!
          </button>
        </div>
      </section>
...
<ProductCarousel productos={productosAnimal} />
      ...
      <section>
        <div ref={seccionFormRegRef}>
          <FormularioRegistro />
        </div>
      </section>

      <section className='Mapa4'>
        <div ref={seccionFindStoreRef}>
          <Mapa />
        </div>
      </section>
